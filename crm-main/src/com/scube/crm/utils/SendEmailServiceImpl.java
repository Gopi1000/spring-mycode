...
public class SendEmailServiceImpl implements SendEmailService {
			...
			public void prepare(MimeMessage mimeMessage) throws Exception {
				...
				File file = new File(
						MyjobkartResourceBundle
								.getValue("logo.for.mail.purposs"));
				File jobseekerFile = new File(
						MyjobkartResourceBundle
								.getValue("jobseeker.home.mail"));
	...
	/* (non-Javadoc)
	 * @see com.scube.crm.utils.SendEmailService#sendloginmail(java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
