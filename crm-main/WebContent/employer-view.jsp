	...
	<div class="item">
		<div class="row">
			<div class="modal-header">
				<button type="button" class="close" id="myModalClose" data-dismiss="modal"
					aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
				<h4 class="modal-title" id="myModalLabel">Client Communication
					History</h4>
			</div>
								...
								<div style="margin-bottom: 0px;">
									<i class="fa fa-calendar"></i><span
										style="font-family: arial; font-size: 12px; margin-left: 5px;"><b>Follow
											Up On:</b> <c:out value="${dateParts[1]}" /></span><br /> <i
					...
					<c:if test="${empty reports}">
						<div class="col-sm-12" style="margin-top: 10px;">
							...
							<div id="DESCID" style="display: none; line-height: 1.5em;">
								...
								<div class="col-sm-3">
									<div class="form-group">
										<input type="submit" id="submitBtId" value="Submit"
