...
public interface QuestionAndExamDao {

	ArrayList<QuizQuestion> retrievequestions(int categoryid,
	...
	QuizQuestion insertanswer(List<QuizQuestion> questionList, int userid, int testId) throws SQLException;
