									...
									<table class="table table-bordered table-hover table-striped">
										...
										<tbody>
											<tr>
												...
												<td style="text-transform: capitalize;"><a href='${pageContext.request.contextPath}/test_review?testId=${results.testId}&userId=${results.userId}'>${results.testType}</a></td>
