			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">
							<i class="fa fa-edit"></i>Create Test Category
						</h1>
				...
				<div class="row">
					<div class="col-lg-4 well">
						<form action="adminCreateTest" method="post">
							<div class="form-group">
								<label>Test Name<font color="red"> *</font></label> <input
									class="form-control" name="testName" type="text"
									required="required" placeholder="Test Name">
							</div>
							...
							<div class="form-group">
								<label>SubCategory<font color="red"> *</font></label><select
									multiple="multiple" name="subcategories" class="form-control"
									id="subcategoryId">
									<option value="">Select SubCategory</option>
