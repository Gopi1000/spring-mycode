									...
									<table class="table table-bordered table-hover table-striped">
										...
										<tbody>
											<tr>
												...
												<td><c:choose>
												<c:when test="${results.answer eq 'null'}">
												
												</c:when><c:otherwise>
												${results.answer}
												</c:otherwise>
												</c:choose>
												<td>${results.correctAnswer}</td> --%>
												<td style="text-transform: capitalize;"><a href='${pageContext.request.contextPath}/test_review?testId=${results.testId}&userId=${userId}'>${results.testType}</a></td>
