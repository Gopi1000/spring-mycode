								...
								<div class="table-responsive">
								 ...
								 <c:forEach items="${testtaken}" var="takentest"> 
										<tbody>
											...
											<td>${takentest.totalQuestion}</td>
											<td>${takentest.totaltimespent}</td>
											<td><a href="viewTakentest?userId=${takentest.userId}&testId=${takentest.testId}" class="btn btn-primary btn-sm"> 
											 <span class="glyphicon glyphicon-book"></span>Review</a></td>
