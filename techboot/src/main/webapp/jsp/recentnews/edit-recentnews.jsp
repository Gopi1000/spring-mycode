...
<section class="container instructor-profile-block checkout-form">
	<form:form name="myForm" id="recendnewsform" method="post" modelAttribute="recentNewsBo"
		...
		<h3 class="text-center">Edit Recent News Details</h3>
		<div class="row">
			<div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
				<div class="form-group">
					...
					<form:input type="text" path="titleName"
						class="form-control element-block" placeholder="titleName" />
		...
		<div class="row">
			...
			<div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
				<div class="form-group">
					...
					<form:errors path="authorName" cssColor="errors" style="color: red"></form:errors>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-6 col-md-4 col-xs-12 col-sm-6">
				<label> RecentNews Logo </label><font style="color: red;">*</font> <input
					type="file" name="recentNewsLogos" path="recentNewsLogo"
