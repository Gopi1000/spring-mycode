...
<script>
	$(document).ready(function() {
		$('#submit').click(function(e) {
			...
			var categoryName = $("#courseCategoryName").val();
			if(null!=categoryName && !categoryName == ''){
			$.ajax({
				type : "GET",
				url : 'check_courseCategoryName',
...
<section class="container instructor-profile-block checkout-form">
	<form:form name="myForm" method="post"
		modelAttribute="courseCategoryBO" commandName="courseCategoryBO"
		class="contact-form top" enctype="multipart/form-data">
		<div class="col-xs-12 col-sm-12">
			<h3 class="text-center">Create Course Category</h3>
