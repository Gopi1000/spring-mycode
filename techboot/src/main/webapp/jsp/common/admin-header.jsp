...
<div id="wrapper">
	...
	<header id="page-header" class="page-header-stick  " style="background-image: url(resource/images/img23.jpg);">
			<!-- top bar -->
			<div class="top-bar bg-dark text-gray heading-banner text-white bgCover" >
				<div class="container">
						...
						<div class="col-xs-9 col">
							...
							<ul class="font-lato list-unstyled bar-links">
								<li><a href="tel:+919790590476"> <strong
										class="dt element-block text-capitalize hd-phone">Call
											:</strong> <strong class="dd element-block hd-phone">+919790590476</strong>
										<i
										class="fa fa-phone hd-up-phone hidden-sm hidden-md hidden-lg"><span
								...
								<li><a href="mailto:enquiry@techboot.com"> <strong
										class="dt element-block text-capitalize hd-phone">Email
											:</strong> <strong class="dd element-block hd-phone">enquiry@techboot.com</strong>
										<i
										class="fa fa-envelope hd-up-phone hidden-sm hidden-md hidden-lg"><span
					...
					<c:when test="${userType eq 'admin'}">
						...
						<li><a href="admin-profile" class="">My Profile</a><span class="sep">|</span>
						   <a href="admin-home" class="">My Home</a> <span
							class="sep">|</span> <a href="logouts" class="">Logout</a></li>
					</ul>
					</c:when>
					<c:otherwise>
					<ul class="list-unstyled user-links fw-bold font-lato">
					<li><a href="view-companydetails" class="">My Profile</a><span class="sep">|</span>
						...
						<a href="logouts" class="">Logout</a></li></ul>
					</c:otherwise>
					</c:choose>
				</div>
					</div>
			...
			<div class="col-xs-6 col-sm-3">
				...
				<div class="logo">
					<a href="home.html"> <img class="hidden-xs" id="logo"
						src="resource/images/logo-white.png" alt="TechBoot"> <img id="logoadmin"
