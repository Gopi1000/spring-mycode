...
<main id="main"> <header id="page-header"> <!-- top bar -->
					...
					<c:choose>
						...
						<c:when test="${userType eq 'admin'}">
							<li><a href="admin-profile" class="">My Profile</a><span class="sep">|</span>
							    <a href="admin-home" class="">My Home</a> <span class="sep">|</span>
								<a href="logouts" class="">Logout</a></li>
						</c:when>
						<c:otherwise>
							<li><a href="${baseURL}/sign-in" class="">Login</a> <span class="sep">|</span>
								<a href="${baseURL}/register-company" class="" title="Register As Partner">Partners</a><span class="sep">|</span>
								<a href="student-register" title="Resgister As Student">Students</a>
								</li>			
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-6 col-sm-3">
				<!-- logo -->
				<div class="logo">
					<a href="${baseURL}/home.html"> <img id="logo"
						src="${baseURL}/resource/images/logo-balck-4.png" alt="TechBoot">
					</a>
				</div>
			</div>
			<div class="col-xs-6 col-sm-9 static-block">
				...
				<div class="collapse navbar-collapse"
					...
					<ul
						...
						<li><a href="${baseURL}/courses-list.html">Courses</a></li>
						<li><a href="${baseURL}/events-list.html">Events</a></li>
				...
				<form action="#" class="navbar-form navbar-search-form navbar-right">
					<a class="fas fa-search search-opener" role="button"
