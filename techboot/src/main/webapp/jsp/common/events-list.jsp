				...
				<ul class="list-unstyled upcoming-events-list">
					<li>
						<div class="alignright">
							<img src="resource/images/img11.jpg" alt="image description">
						</div>
						<div class="alignleft">
						...
						<div class="description-wrap">
							<h3 class="list-heading"><a href="#">WordPress Theme Development with Bootstrap</a></h3>
					...
					<li>
						<div class="alignright">
							<img src="resource/images/img42.jpg" alt="image description">
						</div>
						<div class="alignleft">
							<time datetime="2011-01-12" class="time text-uppercase">
						...
						<div class="description-wrap">
							<h3 class="list-heading"><a href="#">Build Apps with React Native</a></h3>
					...
					<li>
						<div class="alignright">
							<img src="resource/images/img43.jpg" alt="image description">
						</div>
						<div class="alignleft">
							<time datetime="2011-01-12" class="time text-uppercase">
						...
						<div class="description-wrap">
							<h3 class="list-heading"><a href="#">Free Yoga &amp; Excercise Class at Every Morning</a></h3>
					...
					<li>
						<div class="alignright">
							<img src="resource/images/img13.jpg" alt="image description">
						</div>
						<div class="alignleft">
							<time datetime="2011-01-12" class="time text-uppercase">
						...
						<div class="description-wrap">
							<h3 class="list-heading"><a href="#">Free Yoga Class at Every Morning</a></h3>
							<address><time datetime="2011-01-12">8:00 am - 5:00 pm</time> | Great Russell Street, WC1B 3DG UK</address>
							<a href="#" class="btn btn-default text-uppercase">register</a>
						</div>
					</li>
					<li>
						<div class="alignright">
							<img src="resource/images/img39.jpg" alt="image description">
						</div>
						<div class="alignleft">
							<time datetime="2011-01-12" class="time text-uppercase">
						...
						<div class="description-wrap">
							<h3 class="list-heading"><a href="#">Learn Network Webinar for Music Teachers</a></h3>
							<address><time datetime="2011-01-12">12:00 pm - 5:00 pm</time> | No1 Warehouse London, UK</address>
							<a href="#" class="btn btn-default text-uppercase">register</a>
						</div>
					</li>
					<li>
						<div class="alignright">
							<img src="resource/images/img40.jpg" alt="image description">
						</div>
						<div class="alignleft">
							<time datetime="2011-01-12" class="time text-uppercase">
						...
						<div class="description-wrap">
							<h3 class="list-heading"><a href="#">Digital Marketing Briefing: Viyalosla 2017</a></h3>
							<address><time datetime="2011-01-12">4:00 pm - 8:00 pm</time> | 21 New Globe Walk London, UK</address>
							<a href="#" class="btn btn-default text-uppercase">register</a>
						</div>
					</li>
					<li>
						<div class="alignright">
							<img src="resource/images/img41.jpg" alt="image description">
						</div>
						<div class="alignleft">
							<time datetime="2011-01-12" class="time text-uppercase">
								<strong class="date fw-normal">13</strong>
