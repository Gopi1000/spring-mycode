...
<form:form action="edit_company_user" modelAttribute="companyBo" commandName="companyBo" method="post">
...
<form:input path="companyPersonName"/>
<form:input path="firstName"/>
<form:input path="lastName"/>
<form:input path="emailAddress"/>
<form:input path="conformEmailAddress"/>
<form:input path="companyWebSite"/>
<form:input path="companyType"/>
<form:input path="contectNumber"/>
