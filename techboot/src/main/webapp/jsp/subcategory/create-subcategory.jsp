...
<script>
	$(document).ready(function() {
		$('#submit').click(function(e) {
			...
			if(null!=subcategoryName && !subcategoryName == ''){
			$.ajax({
				type : "GET",
				url : 'check-subcategoryName',
				data : 'subcategoryName='+ subcategoryName,
				async: false,
				success : function(data) {
					if(data == "OK"){
						$("#SubCategoryNameErr").show();
 						$("#SubCategoryNameErr").html("SubcategoryName already exist's");
						isValid = false;
				   }else{
					   $("#SubCategoryNameErr").hide();
					   $("#SubCategoryNameErr").css({
							"border" : "",
							"background" : ""
						});
					isValid = true;
...
<section class="container instructor-profile-block checkout-form">
	<form:form name="myForm" method="post"
		modelAttribute="subcategory" commandName="subcategory"
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
						...
						<div class="row">
							<div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
								...
								class="" style="margin-right: 384px;">Category Name <span class="required"><font
										class="f-color">*</font></span></span> <form:select id="category"
							...
							<div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
								<div class="form-group">
									<label class="element-block fw-normal font-lato">
										SubCategoryName<span class="f-color">*</span>
									</label>
									<form:input type="text" path="subcategory"
										id="subcategoryName" class="form-control element-block"
										placeholder="subcategoryName"/>
											<form:errors path="subcategory" cssColor="errors"
										style="color: red"></form:errors>
										<div id="SubCategoryNameErr" style="color: red" ></div>
