...
<section class="container instructor-profile-block">
	...
	<div class="contact-form">
		<h3 class="text-center">View Testimonial Details</h3>
	</div>
	<div class="row">
				...
				<section class="text-center bg-gray">
					<blockquote class="testimonial-quote">
						<span class="avatar rounded-circle element-block"> <img
							...
							src="read_images.html?imgName=${testimonialBo.imageName}&&image=testimonialLogo">
						</span>
					</blockquote>
				</section>
				<div class="row">
						...
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
								<label><i class="fas fa-user-circle"> </i><span
									class="fafa_line_space"> </span>Testimonial Name</label>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
								<span>:<span class="fafa_line_space1">
										${testimonialBo.name}</span></span>
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
								<label><i class="fas fa-user-graduate"></i><span
									class="fafa_line_space"> </span>Profession </label>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
								<span>:<span class="fafa_line_space1">
										${testimonialBo.profession}</span></span>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
								<span>:<span class="fafa_line_space1">
										${testimonialBo.titleName}</span></span>
							</div>
						</div>
					</div>
				</div>
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="col-lg-3 col-md-6 col-sm-6 col-xs-6">
									<label style="margin-left: 14px"><i
										...
										class="fafa_line_space"> </span>Message </label>
								</div>
								<div class="col-lg-9 col-md-6 col-sm-6 col-xs-6">
									<span>:<span class="fafa_line_space1">
											${testimonialBo.message}</span></span>
								</div>
							</div>
						</div>
					</div>
