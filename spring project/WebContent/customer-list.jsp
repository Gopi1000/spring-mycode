...
<td style="border: 1px solid black; text-align: center"><a href="edit-value?id=${vv.customerId}">Edit Value</a></td>
<td style="border: 1px solid black; text-align: center"><a href="delete-value?id=${vv.customerId}">delete Value</a></td>
</tr>
</c:forEach>
</table>
<br>
