...
public class MyClientsException extends java.lang.Exception {

	private static final long serialVersionUID = 1L;

	public static final String DEFAULT_RESOURCE_BUNDLE_NAME = "/com/jobtrolley/resources/jobtrolley-messages";

	private String bundleName = MyClientsException.DEFAULT_RESOURCE_BUNDLE_NAME;
	private String key;
	...
	/**
	 * Constructs an instance of <code>MyClientsException</code> with the
	 ...
	 */
	public MyClientsException(String msg, String resourcekey,
			Object[] parameters) {
		super(msg);
	...
	public MyClientsException(String errorCode, String errorMessage) {
	 ...
	 *            null, if no parameters are used
	 */
	public MyClientsException(Throwable t, String resourcekey,
			Object[] parameters) {
		super(t);
		this.key = resourcekey;
		this.parameters = parameters;
	...
	public MyClientsException() {

	}

	public MyClientsException(String message, String key, Object[] parameters,
			Class<?> bundleResolver) {
		this(message, key, parameters);
		this.setBundleResolver(bundleResolver);
	}

	public MyClientsException(String string) {
