...
public class MyClientsLogger {
	...
	protected MyClientsLogger(String loggerName) {
	...
	protected MyClientsLogger(Class<?> clazzName) {
	...
	public static MyClientsLogger getLogger(String loggerName) {
		return new MyClientsLogger(loggerName);
	}
	...
	public static MyClientsLogger getLogger(Class<?> clazzName) {
		return new MyClientsLogger(clazzName);
	}
	...
	public void entry() {
		if (this.logger.isDebugEnabled()) {
			this.logger.debug(MyClientsLogger.ENTRY_MESSAGE,
	...
	public void exit() {
		if (this.logger.isDebugEnabled()) {
			this.logger
					.debug(MyClientsLogger.EXIT_MESSAGE, this.getCallingMethodName());
		}
	...
	private void addMethodNameToMDC() {
		MDC.put(MyClientsLogger.NAME_KEY, this.getCallingMethodName());
	}
	...
	private String getCallingMethodName() {
		...
		final StackTraceElement[] elements = new MyClientsException()
				.getStackTrace();
