...
public class ClientBO extends BaseBO {
	...
	//private List<Contact> customerUpdateVOList;
	...
	*//**
	...
	/*public List<Contact> getCustomerUpdateVOList() {
		return customerUpdateVOList;
	}
	public void setCustomerUpdateVOList(List<Contact> customerUpdateVOList) {
		this.customerUpdateVOList = customerUpdateVOList;
	}*/
