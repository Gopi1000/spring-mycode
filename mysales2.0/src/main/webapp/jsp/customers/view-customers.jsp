	...
	<div class="item">
		<div class="row ">
			<h3 class="text-center no-margin titleunderline underline"
				style="margin-top: -10px;">View Customers</h3>
				...
				<div class="col-sm-12" style="margin-top: -27px">
					<div class="pi-responsive-table-sm">
						<div class="pi-section-w pi-section-white piTooltips">
							<display:table id="data" name="${listClients}"
                     ...
                     <display:column property="adminUserBO.name" title="Assinged To" />
								...
								<display:column url="contact-details" media="html" paramId="id"
									paramProperty="id" title="Add Contact">
									<a href="contact-details?id=${data.id}&firstName=${data.firstName}"><i
										style="text-align: center;" class="fa fa-plus-circle"></i></a>
								</display:column>
