	...
	<div class="item">
		<div class="row ">
			<h3 class="text-center no-margin titleunderline underline"
				style="margin-top: -10px;">View Report</h3>
			<br>
			...
			<form:form id="myForm" method="post" class="login-form clearfix"
				action="search-report" commandName="searchReport">
				<div class="row"
					...
					<div class=" col-md-2 fs-mobile-search">
						<div class="form-group find-field-space">
							...
							<form:select class="form-control" path="process"
								...
								<form:option value="edit">Customer Tracked</form:option>
							</form:select>
					...
					<div class="pi-responsive-table-sm">
						<div class="pi-section-w pi-section-white piTooltips">
							<display:table id="data" name="${listClients}"
								requestURI="/view-report" pagesize="10" export="false"
								...
								<sec:authorize access="hasRole('ROLE_ADMIN')">
									<display:column property="adminUserBO.name" title="Assigned" />
								</sec:authorize>
