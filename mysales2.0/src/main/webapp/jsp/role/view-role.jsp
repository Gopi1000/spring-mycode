	...
	<div class="item">
		<div class="row ">
			<h3 class="text-center no-margin titleunderline underline"
				style="margin-top: -10px;">View Roles</h3>
					...
					<div class="pi-responsive-table-sm">
						<div class="pi-section-w pi-section-white piTooltips">
							...
							<display:table id="data" name="${viewlist}"
								...
								<display:column url="edit-role" media="html" paramId="roleid"
									paramProperty="roleid" title="Edit">
									<a href="edit-role?roleid=${data.roleid}"><i
										style="text-align: center;" class="fa fa-pencil"></i></a>
								</display:column>



								<display:column url="delete-role" media="html" paramId="roleid"
